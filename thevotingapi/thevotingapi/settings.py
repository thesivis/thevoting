"""
Django settings for thevotingapi project.
...
SECRET_KEY = 'ylta1k=p3#7b3!&inw6l^)ap2)&3s=$8mo=4%od4!j6m3^sg$w'
...
ROOT_URLCONF = 'thevotingapi.urls'
...
WSGI_APPLICATION = 'thevotingapi.wsgi.application'
